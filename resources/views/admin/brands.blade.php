        ...
        <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                        ...
                        <tbody>
                            @foreach ($brandlist as $key => $brand)
                                <tr class="border-b">
                                    ...
                                    <td class="text-sm text-gray-900 font-mono px-6 py-4 whitespace-nowrap">
                                        {{ $brand->active == '1' ? 'active' : 'no active' }}
                                    </td>
                                    <td class="text-sm text-gray-900 font-mono px-6 py-4 whitespace-nowrap">
                                        {{ $brand->created_at }}
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <button
                                            onclick="detailBrand('{{ $brand->id }}', '/admin/brands/{{ $brand->id }}')"
                                        ...
                                        <button onclick="editItem('/admin/brands/{{ $brand->id }}/edit')"
                                        ...
                                        <button onclick="deleteItem('/admin/brands/{{ $brand->id }}')"
                ...
                <div class="flex justify-center mt-4">
                    {{ $brandlist->links('admin.paginate') }}
                </div>
            </div>
        </div>
    </div>
