            ...
            <form action="{{ route('login') }}" method="post">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input id="password" type="password" class="input-box" @error('password') is-invalid @enderror"
                            name="password" required autocomplete="current-password" placeholder="Type Password">
                    </div>
                    @error('password')
                        <div class="bg-yellow-100 rounded-lg py-5 px-6 mb-3 text-base text-yellow-700 inline-flex items-center w-full"
                            role="alert">
                ...
                <div class="flex items-center justify-between mt-6">
                    <div class="flex items-center">
                        <input type="checkbox" class="text-primary focus:ring-0 rounded-sm cursor-pointer" name="remember"
